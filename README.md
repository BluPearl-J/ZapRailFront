...
ZapRailFront
Nomba Connect Hub
ZapVeridian Flow is a robust, high-performance integration engine designed to handle real-time event streaming and webhook consumption. This project focuses on the core challenge of reliable event processing and data integrity.
...
The application will be available at http://localhost:8080/. 3. API Configuration: To toggle between mock data and your backend API, modify src/lib/api/client.ts:

export const USE_MOCK = true; // Set to false to connect to your production Express API
Future Roadmap
